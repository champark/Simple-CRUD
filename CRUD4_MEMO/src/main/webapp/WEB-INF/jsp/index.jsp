...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column" bis_skin_checked="1">
    ...
    <main class="px-3">
        <h1>간단한 메모 프로젝트.</h1>
        <p class="lead">JSP로 구현된 페이지입니다.</p>
        <p class="lead">
            <a href="#" class="btn btn-lg btn-light fw-bold border-white bg-white">입장하기</a>
        </p>
    </main>
